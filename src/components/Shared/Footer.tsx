...
const Footer = () => {
  return (
    <div className="bg-white">
      <div className="mt-10 py-4  max-w-[1203px] mx-auto px-4">
        {/* footer-1st-section  */}
          ...
          <div className="mb-6 lg:mb-0 lg:w-1/2">
            ...
            <div className="my-4">
              <p className="text-lg lg:text-base text-gray-800">
                Scan a Turning Hearts Medallion to learn about and interact{" "}
                <br /> with those who have passed on. You can also begin <br />{" "}
