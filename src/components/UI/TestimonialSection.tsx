...
import img1 from "@/assets/9d3256083f23c02cbc277255042aa364.png";
  ...
  return (
    <div className="bg-gray-100  my-28 max-w-[1203px] p-[15px]  mx-auto">
      ...
      <div className="relative grid md:grid-cols-2 gap-4 w-full  bg-white rounded-lg p-3 lg:p-12  mx-auto">
        {/* Left Side */}
        <div className="bg-blue-600  text-white rounded-lg p-4 w-full  relative">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-sm">Teacher · Non-smoker · Married</p>
